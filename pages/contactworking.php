...
$user_message = $user_name.' <'.$user_email.'>, '.$user_tel.'<br>     '.$user_message;
...
$mail->Host = "https://mail.yandex.ru";        // sets Gmail as the SMTP server
$mail->Port = 587;                     // set the SMTP port for the GMAIL

$mail->Username = "t.jovanovi@ya.ru";  // Gmail username
$mail->Password = "ndxShantiOM_12";      // Gmail password

$mail->CharSet = 'windows-1250';
$mail->SetFrom ('info@example.com', 'From: <admin@krimretrit.ru>');
//$mail->AddBCC ( '___', '___');
...
$mail->AddAddress ('chessmaster7320@gmail.com', 'Dear friend');
// you may also use this format $mail->AddAddress ($recipient);

if(!$mail->Send()) {
  $error_message = "error, odnako";
} else {
  echo "OK";
}
