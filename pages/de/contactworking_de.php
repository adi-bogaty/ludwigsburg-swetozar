        ...
        if (array_key_exists($key, $this->language)) {
            if ('smtp_connect_failed' == $key) {
                ...
                //return $this->language[$key] . ' https://github.com/PHPMailer/PHPMailer/wiki/Troubleshooting';
								return $this->language[$key]. 'Sorry. Message has not been sent. There are some problems with mail server.';
            }
...
$mail->Host = 'mail.krimretrit.ru';  // Specify main and backup SMTP servers
$mail->SMTPAuth = true;                               // Enable SMTP authentication
$mail->Username = 'admin@krimretrit.ru';                 // SMTP username
$mail->Password = 'nimda5';                           // SMTP password
$mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to

$mail->setFrom('admin@krimretrit.ru', 'Mailer');
$mail->addAddress('chessmaster7320@gmail.com', 'Dear human');     // Add a recipient
...
$mail->Subject = 'Новая заявка с сайта krimretrit.ru';
